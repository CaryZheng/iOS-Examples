...
Pod::Spec.new do |spec|
  ...
  spec.name         = "ModuleLogin"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ModuleLogin."
  spec.description  = <<-DESC
      ModuleLogin
                   DESC

  spec.homepage     = "http://zzb/ModuleLogin"
  spec.license      = "MIT"
  spec.author       = "Cary"
  ...
  spec.source       = { :git => "http://zzb/ModuleLogin.git", :tag => "#{spec.version}" }
